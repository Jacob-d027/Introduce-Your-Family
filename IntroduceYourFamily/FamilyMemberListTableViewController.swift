//
//  FamilyMemberListTableViewController.swift
//  IntroduceYourFamily
//
//  Created by Jacob Davis on 11/3/23.
//

import UIKit

class FamilyMemberListTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        content.secondaryText = familyMember.relation
